            ...
            <form id="absensiForm" method="POST" action="{{ route('karyawan.absensi.store') }}">
                ...
                <div class="row g-3 align-items-stretch">
                    <div class="col d-flex flex-column">
                        ...
                        <button type="button" onclick="capture()" class="btn btn-primary w-100"><i class="fas fa-camera me-2"></i> Ambil Foto</button>
                    </div>

                    <div class="col d-flex flex-column">
                        <div
                            class="mb-3 w-100 border rounded overflow-hidden flex-fill d-flex justify-content-center align-items-center" style="background-color: black;">
                            <img id="preview" src="" alt="Preview" style="display:none;">
                        </div>
                        <button id="sendBtn" type="button" onclick="send()" class="btn btn-success w-100" disabled><i class="fas fa-check me-2"></i> Kirim
                            Absensi</button>
                    </div>
                </div>
                <div class="row">
                ...
                function initLocation(){
                    ...
                    .then(async (coords) => {
                        ...
                        try {
                            ...
                            const res = await fetch(`https://api-bdc.net/data/reverse-geocode-client?latitude=-8.0020045&longitude=111.9832964&localityLanguage=id`);
